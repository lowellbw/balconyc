...
Resolution is a legibility decision, not a detail one. At 36 columns the
East and Harlem Rivers close up and Manhattan merges into the Bronx and
Queens, so the map reads as one blob. 72 is where the rivers open and
Manhattan reads as itself, while blocks stay ~10px on a desktop hero —
comfortably above the ~5px floor where the gaps start to alias into stripes.
